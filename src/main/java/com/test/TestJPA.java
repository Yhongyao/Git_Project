...
//		 TestJPA.update();
	...
	private static void query_one() {
		...
		try {
			...
			tx.begin();
			//
			UserBean userBean = manager.find(UserBean.class, new Integer(50));
	...
	private static void delete() {
		...
		try {
			...
			tx.begin();
			//
			UserBean userBean = manager.find(UserBean.class, new Integer(51));
